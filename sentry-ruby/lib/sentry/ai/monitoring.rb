    ...
    module Monitoring
      ...
      class << self
        ...
        def record_token_usage(span, prompt_tokens: nil, completion_tokens: nil, total_tokens: nil)
          ...
          span.set_data("ai.prompt_tokens.used", value: prompt_tokens)
          span.set_data("ai.completion_tokens.used", value: completion_tokens)
          span.set_data("ai.total_tokens.used", value: total_tokens)
