...
RSpec.describe Sentry::Rails::LogSubscribers::ActiveJobSubscriber, skip: Rails.version.to_f < 5.1 ? "Rails 5.0.0 has incomplete ActiveJob instrumentation" : false do
  before do
